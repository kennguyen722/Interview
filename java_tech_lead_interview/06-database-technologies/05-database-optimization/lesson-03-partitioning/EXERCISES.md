## Exercise 1: Apply Partitioning Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Partitioning.
...
Description: Extend solution to handle one edge or failure scenario related to Partitioning.
