## Exercise 1: Apply Query Optimization Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Query Optimization.
...
Description: Extend solution to handle one edge or failure scenario related to Query Optimization.
