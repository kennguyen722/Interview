## Exercise 1: Apply Column Family Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Column Family.
...
Description: Extend solution to handle one edge or failure scenario related to Column Family.
