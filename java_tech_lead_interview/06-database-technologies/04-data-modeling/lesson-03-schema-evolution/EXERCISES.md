## Exercise 1: Apply Schema Evolution Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Schema Evolution.
...
Description: Extend solution to handle one edge or failure scenario related to Schema Evolution.
