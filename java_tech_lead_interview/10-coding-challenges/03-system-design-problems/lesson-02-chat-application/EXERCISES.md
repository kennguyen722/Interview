## Exercise 1: Apply Chat Application Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Chat Application.
...
Description: Extend solution to handle one edge or failure scenario related to Chat Application.
