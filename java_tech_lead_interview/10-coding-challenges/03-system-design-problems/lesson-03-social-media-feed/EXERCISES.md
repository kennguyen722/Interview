## Exercise 1: Apply Social Media Feed Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Social Media Feed.
...
Description: Extend solution to handle one edge or failure scenario related to Social Media Feed.
