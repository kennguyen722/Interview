## Exercise 1: Apply Graph Algorithms Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Graph Algorithms.
...
Description: Extend solution to handle one edge or failure scenario related to Graph Algorithms.
