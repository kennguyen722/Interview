## Exercise 1: Apply Security Review Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Security Review.
...
Description: Extend solution to handle one edge or failure scenario related to Security Review.
