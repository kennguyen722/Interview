# Lesson 01: Conflict Resolution

## 1. Learning Objectives
- Understand Conflict Resolution fundamentals
- Apply Conflict Resolution in leadership scenarios
- Communicate trade-offs and best practices clearly

## 2. Why This Matters for a Java Tech Lead
A Tech Lead must evaluate, justify, and guide correct usage of Conflict Resolution ensuring reliability, performance, and maintainability across teams. Mastery enables mentoring and architectural judgment.

## 3. Core Theory
### 3.1 Key Concepts
This section presents the foundational concepts of conflict-resolution relevant to the leadership domain.
- Influence vs authority mechanics
- Decision frameworks and risk
...
Context: Senior engineer overloaded; choose delegation path balancing growth & delivery.

#### Scenario 2: Conflict Mediation
Technique: Separate facts from interpretations; facilitate shared goals matrix.

#### Scenario 3: Technical Vision Pitch
Structure: Problem framing -> Option trade-offs -> Strategic bet -> Incremental roadmap.
...
Goal: Demonstrate baseline conflict-resolution usage.
Acceptance: Clear, correct behavior.

### Exercise 2: Advanced Scenario
Goal: Extend solution with resilience/performance nuance.
Acceptance: Handles edge cases; basic metrics captured.

## 7. Interview Cheat Sheet
Definition: One-liner summarizing conflict-resolution.
