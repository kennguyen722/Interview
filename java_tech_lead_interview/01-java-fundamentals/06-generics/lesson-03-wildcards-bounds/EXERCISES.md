## Exercise 1: Apply Wildcards Bounds Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Wildcards Bounds.
...
Description: Extend solution to handle one edge or failure scenario related to Wildcards Bounds.
