## Exercise 1: Apply Try Catch Finally Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Try Catch Finally.
...
Description: Extend solution to handle one edge or failure scenario related to Try Catch Finally.
