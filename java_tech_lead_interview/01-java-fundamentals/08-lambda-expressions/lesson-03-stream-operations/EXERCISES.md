## Exercise 1: Apply Stream Operations Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Stream Operations.
...
Description: Extend solution to handle one edge or failure scenario related to Stream Operations.
