## Exercise 1: Apply Nio Fundamentals Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Nio Fundamentals.
...
Description: Extend solution to handle one edge or failure scenario related to Nio Fundamentals.
