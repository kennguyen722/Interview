## Exercise 1: Apply Stream Processing Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Stream Processing.
...
Description: Extend solution to handle one edge or failure scenario related to Stream Processing.
