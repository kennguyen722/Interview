## Exercise 1: Apply Database Services Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Database Services.
...
Description: Extend solution to handle one edge or failure scenario related to Database Services.
