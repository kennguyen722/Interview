## Exercise 1: Apply X Ray Tracing Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of X Ray Tracing.
...
Description: Extend solution to handle one edge or failure scenario related to X Ray Tracing.
