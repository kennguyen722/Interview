## Exercise 1: Apply Iam Security Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Iam Security.
...
Description: Extend solution to handle one edge or failure scenario related to Iam Security.
