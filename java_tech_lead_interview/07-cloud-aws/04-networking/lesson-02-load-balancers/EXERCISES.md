## Exercise 1: Apply Load Balancers Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Load Balancers.
...
Description: Extend solution to handle one edge or failure scenario related to Load Balancers.
