## Exercise 1: Apply Vpc Setup Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Vpc Setup.
...
Description: Extend solution to handle one edge or failure scenario related to Vpc Setup.
