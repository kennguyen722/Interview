## Exercise 1: Apply Dns Routing Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Dns Routing.
...
Description: Extend solution to handle one edge or failure scenario related to Dns Routing.
