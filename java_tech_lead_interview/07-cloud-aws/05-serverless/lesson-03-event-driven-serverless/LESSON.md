# Lesson 03: Event Driven Serverless

## 1. Learning Objectives
- Understand Event Driven Serverless fundamentals
- Apply Event Driven Serverless in general scenarios
- Communicate trade-offs and best practices clearly

## 2. Why This Matters for a Java Tech Lead
A Tech Lead must evaluate, justify, and guide correct usage of Event Driven Serverless ensuring reliability, performance, and maintainability across teams. Mastery enables mentoring and architectural judgment.

## 3. Core Theory
### 3.1 Key Concepts
This section presents the foundational concepts of event-driven-serverless relevant to the general domain.
- Key definition
- Primary components
- Usage flow
...
Goal: Demonstrate baseline event-driven-serverless usage.
...
Definition: One-liner summarizing event-driven-serverless.
