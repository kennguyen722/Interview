## Exercise 1: Apply Container Services Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Container Services.
...
Description: Extend solution to handle one edge or failure scenario related to Container Services.
