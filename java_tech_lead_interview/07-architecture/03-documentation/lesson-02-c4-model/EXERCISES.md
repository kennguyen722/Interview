## Exercise 1: Apply C4 Model Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of C4 Model.
...
Description: Extend solution to handle one edge or failure scenario related to C4 Model.
