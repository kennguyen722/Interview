## Exercise 1: Apply Reactive Streams Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Reactive Streams.
...
Description: Extend solution to handle one edge or failure scenario related to Reactive Streams.
