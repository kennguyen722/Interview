## Exercise 1: Apply Method Security Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Method Security.
...
Description: Extend solution to handle one edge or failure scenario related to Method Security.
