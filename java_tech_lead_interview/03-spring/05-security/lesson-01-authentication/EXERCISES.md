## Exercise 1: Apply Authentication Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Authentication.
...
Description: Extend solution to handle one edge or failure scenario related to Authentication.
