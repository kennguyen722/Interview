## Exercise 1: Apply Authorization Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Authorization.
...
Description: Extend solution to handle one edge or failure scenario related to Authorization.
