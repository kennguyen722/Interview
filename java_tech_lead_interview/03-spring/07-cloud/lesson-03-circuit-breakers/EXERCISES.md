## Exercise 1: Apply Circuit Breakers Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Circuit Breakers.
...
Description: Extend solution to handle one edge or failure scenario related to Circuit Breakers.
