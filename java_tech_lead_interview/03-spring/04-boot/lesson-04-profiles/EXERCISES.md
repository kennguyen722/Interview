## Exercise 1: Apply Profiles Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Profiles.
...
Description: Extend solution to handle one edge or failure scenario related to Profiles.
