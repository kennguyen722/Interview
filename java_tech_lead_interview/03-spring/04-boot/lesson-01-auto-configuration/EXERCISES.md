## Exercise 1: Apply Auto Configuration Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Auto Configuration.
...
Description: Extend solution to handle one edge or failure scenario related to Auto Configuration.
