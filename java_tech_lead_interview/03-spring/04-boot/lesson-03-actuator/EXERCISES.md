## Exercise 1: Apply Actuator Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Actuator.
...
Description: Extend solution to handle one edge or failure scenario related to Actuator.
