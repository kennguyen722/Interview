## Exercise 1: Apply Starters Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Starters.
...
Description: Extend solution to handle one edge or failure scenario related to Starters.
