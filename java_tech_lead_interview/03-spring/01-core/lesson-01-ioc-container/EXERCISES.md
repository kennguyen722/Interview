## Exercise 1: Apply Ioc Container Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Ioc Container.
...
Description: Extend solution to handle one edge or failure scenario related to Ioc Container.
