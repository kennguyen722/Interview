## Exercise 1: Apply Aop Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Aop.
...
Description: Extend solution to handle one edge or failure scenario related to Aop.
