## Exercise 1: Apply Validation Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Validation.
...
Description: Extend solution to handle one edge or failure scenario related to Validation.
