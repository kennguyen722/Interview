## Exercise 1: Apply Testing Apis Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Testing Apis.
...
Description: Extend solution to handle one edge or failure scenario related to Testing Apis.
