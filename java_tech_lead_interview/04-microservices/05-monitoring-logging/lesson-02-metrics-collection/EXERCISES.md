## Exercise 1: Apply Metrics Collection Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Metrics Collection.
...
Description: Extend solution to handle one edge or failure scenario related to Metrics Collection.
