## Exercise 1: Apply Metrics Monitoring Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Metrics Monitoring.
...
Description: Extend solution to handle one edge or failure scenario related to Metrics Monitoring.
