## Exercise 1: Apply Blue Green Canary Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Blue Green Canary.
...
Description: Extend solution to handle one edge or failure scenario related to Blue Green Canary.
