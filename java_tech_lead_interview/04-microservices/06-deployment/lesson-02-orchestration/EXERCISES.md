## Exercise 1: Apply Orchestration Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Orchestration.
...
Description: Extend solution to handle one edge or failure scenario related to Orchestration.
