## Exercise 1: Apply Timeout Patterns Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Timeout Patterns.
...
Description: Extend solution to handle one edge or failure scenario related to Timeout Patterns.
