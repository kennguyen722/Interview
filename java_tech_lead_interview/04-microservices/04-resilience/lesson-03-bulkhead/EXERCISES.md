## Exercise 1: Apply Bulkhead Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Bulkhead.
...
Description: Extend solution to handle one edge or failure scenario related to Bulkhead.
