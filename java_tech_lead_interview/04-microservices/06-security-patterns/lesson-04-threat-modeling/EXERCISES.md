## Exercise 1: Apply Threat Modeling Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Threat Modeling.
...
Description: Extend solution to handle one edge or failure scenario related to Threat Modeling.
