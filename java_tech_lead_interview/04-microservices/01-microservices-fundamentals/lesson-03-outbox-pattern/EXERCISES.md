## Exercise 1: Apply Outbox Pattern Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Outbox Pattern.
...
Description: Extend solution to handle one edge or failure scenario related to Outbox Pattern.
