...
- Apply Type Erasure in java-basics scenarios
...
## 3. Core Theory
### 3.1 Key Concepts
This section presents the foundational concepts of type-erasure relevant to the java-basics domain.
...
Goal: Implement type-erasure fundamentals (immutability, basic API).
Tasks:
