## Exercise 1: Apply Iterators Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Iterators.
...
Description: Extend solution to handle one edge or failure scenario related to Iterators.
