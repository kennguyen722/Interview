## Exercise 1: Apply Map Filter Reduce Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Map Filter Reduce.
...
Description: Extend solution to handle one edge or failure scenario related to Map Filter Reduce.
