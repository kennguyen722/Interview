## Exercise 1: Apply Collectors Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Collectors.
...
Description: Extend solution to handle one edge or failure scenario related to Collectors.
