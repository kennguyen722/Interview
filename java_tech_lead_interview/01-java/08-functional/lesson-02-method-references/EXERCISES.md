## Exercise 1: Apply Method References Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Method References.
...
Description: Extend solution to handle one edge or failure scenario related to Method References.
