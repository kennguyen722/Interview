## Exercise 1: Apply Control Flow Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Control Flow.
...
Description: Extend solution to handle one edge or failure scenario related to Control Flow.
