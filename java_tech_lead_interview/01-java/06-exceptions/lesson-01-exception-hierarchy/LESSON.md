...
- Apply Exception Hierarchy in java-basics scenarios
...
## 3. Core Theory
### 3.1 Key Concepts
This section presents the foundational concepts of exception-hierarchy relevant to the java-basics domain.
...
Goal: Implement exception-hierarchy fundamentals (immutability, basic API).
Tasks:
