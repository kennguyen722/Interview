## Exercise 1: Apply Custom Exceptions Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Custom Exceptions.
...
Description: Extend solution to handle one edge or failure scenario related to Custom Exceptions.
