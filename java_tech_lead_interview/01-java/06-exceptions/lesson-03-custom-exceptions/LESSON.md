...
- Apply Custom Exceptions in java-basics scenarios
...
## 3. Core Theory
### 3.1 Key Concepts
This section presents the foundational concepts of custom-exceptions relevant to the java-basics domain.
...
Goal: Implement custom-exceptions fundamentals (immutability, basic API).
Tasks:
