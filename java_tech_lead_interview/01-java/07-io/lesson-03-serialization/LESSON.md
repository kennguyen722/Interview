...
- Apply Serialization in java-basics scenarios
...
## 3. Core Theory
### 3.1 Key Concepts
This section presents the foundational concepts of serialization relevant to the java-basics domain.
...
Goal: Implement serialization fundamentals (immutability, basic API).
Tasks:
