## Exercise 1: Apply Terraform Basics Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Terraform Basics.
...
Description: Extend solution to handle one edge or failure scenario related to Terraform Basics.
