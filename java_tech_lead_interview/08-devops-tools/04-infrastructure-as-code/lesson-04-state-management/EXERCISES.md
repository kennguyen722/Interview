## Exercise 1: Apply State Management Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of State Management.
...
Description: Extend solution to handle one edge or failure scenario related to State Management.
