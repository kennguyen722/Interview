## Exercise 1: Apply Cloudformation Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Cloudformation.
...
Description: Extend solution to handle one edge or failure scenario related to Cloudformation.
