## Exercise 1: Apply Ebs Efs Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Ebs Efs.
...
Description: Extend solution to handle one edge or failure scenario related to Ebs Efs.
