## Exercise 1: Apply Api Gateway Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Api Gateway.
...
Description: Extend solution to handle one edge or failure scenario related to Api Gateway.
