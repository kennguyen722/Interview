## Exercise 1: Apply Vpc Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Vpc.
...
Description: Extend solution to handle one edge or failure scenario related to Vpc.
