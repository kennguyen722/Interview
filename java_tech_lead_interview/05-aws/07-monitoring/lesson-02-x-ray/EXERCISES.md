## Exercise 1: Apply X Ray Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of X Ray.
...
Description: Extend solution to handle one edge or failure scenario related to X Ray.
