## Exercise 1: Apply Cloudwatch Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Cloudwatch.
...
Description: Extend solution to handle one edge or failure scenario related to Cloudwatch.
