## Exercise 1: Apply Lambda Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Lambda.
...
Description: Extend solution to handle one edge or failure scenario related to Lambda.
