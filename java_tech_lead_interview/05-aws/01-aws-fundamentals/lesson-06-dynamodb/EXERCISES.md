## Exercise 1: Apply Dynamodb Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Dynamodb.
...
Description: Extend solution to handle one edge or failure scenario related to Dynamodb.
