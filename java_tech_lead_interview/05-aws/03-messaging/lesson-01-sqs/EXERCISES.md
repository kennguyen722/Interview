## Exercise 1: Apply Sqs Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Sqs.
...
Description: Extend solution to handle one edge or failure scenario related to Sqs.
