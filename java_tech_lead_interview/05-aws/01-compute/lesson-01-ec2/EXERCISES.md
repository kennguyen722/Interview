## Exercise 1: Apply Ec2 Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Ec2.
...
Description: Extend solution to handle one edge or failure scenario related to Ec2.
