## Exercise 1: Apply Ecs Fargate Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Ecs Fargate.
...
Description: Extend solution to handle one edge or failure scenario related to Ecs Fargate.
