## Exercise 1: Apply Nosql Patterns Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Nosql Patterns.
...
Description: Extend solution to handle one edge or failure scenario related to Nosql Patterns.
