## Exercise 1: Apply Vertical Scaling Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Vertical Scaling.
...
Description: Extend solution to handle one edge or failure scenario related to Vertical Scaling.
