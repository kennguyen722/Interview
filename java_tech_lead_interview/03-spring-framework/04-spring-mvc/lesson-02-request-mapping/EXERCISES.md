## Exercise 1: Apply Request Mapping Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Request Mapping.
...
Description: Extend solution to handle one edge or failure scenario related to Request Mapping.
