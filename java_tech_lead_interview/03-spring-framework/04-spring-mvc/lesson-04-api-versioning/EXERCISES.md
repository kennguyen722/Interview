## Exercise 1: Apply Api Versioning Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Api Versioning.
...
Description: Extend solution to handle one edge or failure scenario related to Api Versioning.
