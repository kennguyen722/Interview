## Exercise 1: Apply Query Methods Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Query Methods.
...
Description: Extend solution to handle one edge or failure scenario related to Query Methods.
