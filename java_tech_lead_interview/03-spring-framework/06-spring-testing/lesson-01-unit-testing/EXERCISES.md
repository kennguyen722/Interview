## Exercise 1: Apply Unit Testing Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Unit Testing.
...
Description: Extend solution to handle one edge or failure scenario related to Unit Testing.
