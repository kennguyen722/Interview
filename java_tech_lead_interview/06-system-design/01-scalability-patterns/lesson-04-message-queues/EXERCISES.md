## Exercise 1: Apply Message Queues Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Message Queues.
...
Description: Extend solution to handle one edge or failure scenario related to Message Queues.
