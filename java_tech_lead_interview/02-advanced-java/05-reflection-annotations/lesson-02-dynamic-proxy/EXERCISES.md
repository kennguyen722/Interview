## Exercise 1: Apply Dynamic Proxy Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Dynamic Proxy.
...
Description: Extend solution to handle one edge or failure scenario related to Dynamic Proxy.
