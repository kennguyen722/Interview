## Exercise 1: Apply Gc Tuning Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Gc Tuning.
...
Description: Extend solution to handle one edge or failure scenario related to Gc Tuning.
