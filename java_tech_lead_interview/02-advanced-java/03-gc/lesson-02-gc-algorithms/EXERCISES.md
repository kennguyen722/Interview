## Exercise 1: Apply Gc Algorithms Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Gc Algorithms.
...
Description: Extend solution to handle one edge or failure scenario related to Gc Algorithms.
