# Lesson 01: Creational Patterns

## 1. Learning Objectives
- Understand Creational Patterns fundamentals
- Apply Creational Patterns in advanced-java scenarios
- Communicate trade-offs and best practices clearly

## 2. Why This Matters for a Java Tech Lead
A Tech Lead must evaluate, justify, and guide correct usage of Creational Patterns ensuring reliability, performance, and maintainability across teams. Mastery enables mentoring and architectural judgment.

## 3. Core Theory
### 3.1 Key Concepts
This section presents the foundational concepts of creational-patterns relevant to the advanced-java domain.
...
Definition: One-liner summarizing creational-patterns.
