## Exercise 1: Apply Http Clients Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Http Clients.
...
Description: Extend solution to handle one edge or failure scenario related to Http Clients.
