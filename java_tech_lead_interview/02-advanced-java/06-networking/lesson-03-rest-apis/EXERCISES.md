## Exercise 1: Apply Rest Apis Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Rest Apis.
...
Description: Extend solution to handle one edge or failure scenario related to Rest Apis.
