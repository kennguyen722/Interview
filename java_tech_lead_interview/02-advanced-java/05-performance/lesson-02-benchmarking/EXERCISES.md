## Exercise 1: Apply Benchmarking Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Benchmarking.
...
Description: Extend solution to handle one edge or failure scenario related to Benchmarking.
