## Exercise 1: Apply Monitoring Tools Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Monitoring Tools.
...
Description: Extend solution to handle one edge or failure scenario related to Monitoring Tools.
