## Exercise 1: Apply Java Memory Model Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Java Memory Model.
...
Description: Extend solution to handle one edge or failure scenario related to Java Memory Model.
