## Exercise 1: Apply Locks Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Locks.
...
Description: Extend solution to handle one edge or failure scenario related to Locks.
