## Exercise 1: Apply Locks Conditions Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Locks Conditions.
...
Description: Extend solution to handle one edge or failure scenario related to Locks Conditions.
