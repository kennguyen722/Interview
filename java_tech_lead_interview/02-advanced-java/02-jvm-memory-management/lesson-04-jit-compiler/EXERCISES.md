## Exercise 1: Apply Jit Compiler Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Jit Compiler.
...
Description: Extend solution to handle one edge or failure scenario related to Jit Compiler.
