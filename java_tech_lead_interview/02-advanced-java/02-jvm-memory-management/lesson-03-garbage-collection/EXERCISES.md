## Exercise 1: Apply Garbage Collection Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Garbage Collection.
...
Description: Extend solution to handle one edge or failure scenario related to Garbage Collection.
