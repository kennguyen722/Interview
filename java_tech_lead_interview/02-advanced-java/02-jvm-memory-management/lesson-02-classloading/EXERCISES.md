## Exercise 1: Apply Classloading Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Classloading.
...
Description: Extend solution to handle one edge or failure scenario related to Classloading.
