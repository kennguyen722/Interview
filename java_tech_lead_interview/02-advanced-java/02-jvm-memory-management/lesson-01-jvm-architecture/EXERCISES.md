## Exercise 1: Apply Jvm Architecture Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Jvm Architecture.
...
Description: Extend solution to handle one edge or failure scenario related to Jvm Architecture.
