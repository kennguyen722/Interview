## Exercise 1: Apply Cryptography Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Cryptography.
...
Description: Extend solution to handle one edge or failure scenario related to Cryptography.
