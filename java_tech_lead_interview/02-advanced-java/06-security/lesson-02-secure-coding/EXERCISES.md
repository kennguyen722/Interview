## Exercise 1: Apply Secure Coding Basics
Goal: Reinforce fundamental concept.
Description: Implement a minimal example demonstrating primary mechanism of Secure Coding.
...
Description: Extend solution to handle one edge or failure scenario related to Secure Coding.
