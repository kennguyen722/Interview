# Lesson 02: Performance Management

## 1. Learning Objectives
- Understand Performance Management fundamentals
- Apply Performance Management in general scenarios
...
## 3. Core Theory
### 3.1 Key Concepts
This section presents the foundational concepts of performance-management relevant to the general domain.
- Key definition
- Primary components
- Usage flow
