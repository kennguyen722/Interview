# Detailed Lecture Notes - Lesson 10.4: Mentoring and Team Practices

## Lesson Context
- Module: Professional Engineering and Leadership (Weeks 29-30)
- Primary topics: Pair programming, onboarding, growth plans; Engineering culture and delivery excellence
- Target output: Team playbook draft
...
- **Pair programming**: Pair programming is a key concept in this lesson.
- **onboarding**: onboarding is a key concept in this lesson.
- **growth plans**: growth plans is a key concept in this lesson.
- **Engineering culture**: Engineering culture is a key concept in this lesson.
- **delivery excellence**: delivery excellence is a key concept in this lesson.
