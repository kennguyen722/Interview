# Detailed Lecture Notes - Lesson 9.1: Microservices Design

## Lesson Context
- Module: Advanced Architecture and Distributed Systems (Weeks 25-28)
- Primary topics: Service boundaries and decomposition patterns; Synchronous vs asynchronous communication
- Target output: Service decomposition document
...
- **Service boundaries**: Service boundaries is a key concept in this lesson.
- **decomposition patterns**: decomposition patterns is a key concept in this lesson.
- **Synchronous vs asynchronous communication**: Synchronous vs asynchronous communication is a key concept in this lesson.
