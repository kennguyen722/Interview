# Detailed Lecture Notes - Lesson 4.1: Spring Core Concepts

## Lesson Context
- Module: Spring Boot Backend Development (Weeks 11-14)
- Primary topics: IoC, DI, bean lifecycle; Configuration and profiles
- Target output: Basic Spring app with profile switching
...
- **IoC**: IoC is a key concept in this lesson.
- **bean lifecycle**: bean lifecycle is a key concept in this lesson.
- **Configuration**: Configuration is a key concept in this lesson.
- **profiles**: profiles is a key concept in this lesson.
