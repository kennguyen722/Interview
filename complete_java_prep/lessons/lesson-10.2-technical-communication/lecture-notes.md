# Detailed Lecture Notes - Lesson 10.2: Technical Communication

## Lesson Context
- Module: Professional Engineering and Leadership (Weeks 29-30)
- Primary topics: Design docs, RFCs, and stakeholder updates; Presenting trade-offs clearly
- Target output: Design review presentation
...
- **Design docs**: Design docs is a key concept in this lesson.
- **RFCs**: RFCs is a key concept in this lesson.
- **stakeholder updates**: stakeholder updates is a key concept in this lesson.
- **Presenting trade-offs clearly**: Presenting trade-offs clearly is a key concept in this lesson.
