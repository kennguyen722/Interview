# Detailed Lecture Notes - Lesson 5.4: Event-Driven Architecture Basics

## Lesson Context
- Module: Data Layer and Messaging (Weeks 15-16)
- Primary topics: Message brokers (Kafka/RabbitMQ) concepts; Producers, consumers, retries, DLQ
- Target output: Event-driven order workflow prototype
...
- **Message brokers**: Message brokers is a key concept in this lesson.
- **Kafka**: A distributed event streaming platform.
- **RabbitMQ**: A broker for reliable asynchronous messaging.
- **concepts**: concepts is a key concept in this lesson.
- **Producers**: Producers is a key concept in this lesson.
- **consumers**: consumers is a key concept in this lesson.
- **retries**: retries is a key concept in this lesson.
- **DLQ**: DLQ is a key concept in this lesson.
