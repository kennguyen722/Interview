# Detailed Lecture Notes - Lesson 11.3: Capstone Build Sprint 2

## Lesson Context
- Module: Capstone and Interview Readiness (Weeks 31-32)
- Primary topics: Frontend, integration, observability
- Target output: End-to-end product increment
...
- **Frontend**: Frontend is a key concept in this lesson.
- **integration**: integration is a key concept in this lesson.
- **observability**: observability is a key concept in this lesson.
