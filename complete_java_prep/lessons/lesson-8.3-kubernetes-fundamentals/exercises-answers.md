# Exercise Answers - Lesson 8.3: Kubernetes Fundamentals
...
- Process: logic for Deployments, services, ingress, config/secrets; Horizontal scaling and rolling updates.
