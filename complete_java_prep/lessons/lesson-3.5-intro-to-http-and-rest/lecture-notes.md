# Detailed Lecture Notes - Lesson 3.5: Intro to HTTP and REST

## Lesson Context
- Module: Software Engineering Essentials (Weeks 8-10)
- Primary topics: HTTP methods, status codes, headers; REST constraints and resource modeling
- Target output: API contract for upcoming backend
...
- **HTTP methods**: HTTP methods is a key concept in this lesson.
- **status codes**: status codes is a key concept in this lesson.
- **headers**: headers is a key concept in this lesson.
- **REST constraints**: REST constraints is a key concept in this lesson.
- **resource modeling**: resource modeling is a key concept in this lesson.
