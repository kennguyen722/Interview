# Detailed Lecture Notes - Lesson 6.4: Secure Coding and Compliance Basics

## Lesson Context
- Module: Security and Identity (Weeks 17-18)
- Primary topics: Audit logging, PII handling, encryption at rest/in transit; Intro to SOC2/GDPR-aligned engineering behaviors
- Target output: Security review document for project
...
- **Audit logging**: Audit logging is a key concept in this lesson.
- **PII handling**: PII handling is a key concept in this lesson.
- **encryption at rest**: encryption at rest is a key concept in this lesson.
- **in transit**: in transit is a key concept in this lesson.
- **Intro to SOC2**: Intro to SOC2 is a key concept in this lesson.
- **GDPR-aligned engineering behaviors**: GDPR-aligned engineering behaviors is a key concept in this lesson.
