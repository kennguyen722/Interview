# Detailed Lecture Notes - Lesson 1.1: Java Syntax and Data Types

## Lesson Context
- Module: Java Core for Beginners (Weeks 2-4)
- Primary topics: Variables, primitive/reference types, operators; Type conversion and common pitfalls
- Target output: Simple calculator + input validation
...
- **Variables**: Variables is a key concept in this lesson.
- **primitive**: A built-in Java value type, such as int, double, or boolean.
- **reference types**: reference types is a key concept in this lesson.
- **operators**: operators is a key concept in this lesson.
- **Type conversion**: Type conversion is a key concept in this lesson.
- **common pitfalls**: common pitfalls is a key concept in this lesson.
