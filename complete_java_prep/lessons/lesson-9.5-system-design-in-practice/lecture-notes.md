# Detailed Lecture Notes - Lesson 9.5: System Design in Practice

## Lesson Context
- Module: Advanced Architecture and Distributed Systems (Weeks 25-28)
- Primary topics: Non-functional requirements and trade-off analysis; Capacity estimation and architecture diagrams
- Target output: Full architecture case study
...
- **Non-functional requirements**: Non-functional requirements is a key concept in this lesson.
- **trade-off analysis**: trade-off analysis is a key concept in this lesson.
- **Capacity estimation**: Capacity estimation is a key concept in this lesson.
- **architecture diagrams**: architecture diagrams is a key concept in this lesson.
