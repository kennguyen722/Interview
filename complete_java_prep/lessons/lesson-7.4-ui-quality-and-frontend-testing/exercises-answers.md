# Exercise Answers - Lesson 7.4: UI Quality and Frontend Testing
...
- Process: logic for Accessibility basics (a11y), responsive design; Unit and integration tests with RTL/Vitest/Jest.
