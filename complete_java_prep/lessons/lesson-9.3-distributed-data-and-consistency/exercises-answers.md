# Exercise Answers - Lesson 9.3: Distributed Data and Consistency
...
- Process: logic for Saga pattern, outbox pattern, eventual consistency; Idempotency and exactly-once myths.
