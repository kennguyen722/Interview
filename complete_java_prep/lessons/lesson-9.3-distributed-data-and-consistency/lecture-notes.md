# Detailed Lecture Notes - Lesson 9.3: Distributed Data and Consistency

## Lesson Context
- Module: Advanced Architecture and Distributed Systems (Weeks 25-28)
- Primary topics: Saga pattern, outbox pattern, eventual consistency; Idempotency and exactly-once myths
- Target output: Transactional workflow with compensations
...
- **Saga pattern**: Saga pattern is a key concept in this lesson.
- **outbox pattern**: outbox pattern is a key concept in this lesson.
- **eventual consistency**: eventual consistency is a key concept in this lesson.
- **Idempotency**: Idempotency is a key concept in this lesson.
- **exactly-once myths**: exactly-once myths is a key concept in this lesson.
