# Sample Project: Lesson 9.3

## Goal
Build a working mini project for **Distributed Data and Consistency**.
...
- Output aligns with: **Transactional workflow with compensations**.
