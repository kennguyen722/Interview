# Detailed Lecture Notes - Lesson 2.4: File I/O and NIO

## Lesson Context
- Module: Java Intermediate Core (Weeks 5-7)
- Primary topics: File APIs, paths, readers/writers; Serialization formats (JSON/CSV basics)
- Target output: CLI data import/export tool
...
- **File APIs**: File APIs is a key concept in this lesson.
- **paths**: paths is a key concept in this lesson.
- **readers**: readers is a key concept in this lesson.
- **writers**: writers is a key concept in this lesson.
- **Serialization formats**: Serialization formats is a key concept in this lesson.
- **JSON**: JSON is a key concept in this lesson.
- **CSV basics**: CSV basics is a key concept in this lesson.
