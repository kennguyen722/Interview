# Detailed Lecture Notes - Lesson 5.3: Intro to NoSQL (MongoDB)

## Lesson Context
- Module: Data Layer and Messaging (Weeks 15-16)
- Primary topics: Document modeling and access patterns; Trade-offs vs relational design
- Target output: Hybrid data storage proof of concept
...
- **Document modeling**: Document modeling is a key concept in this lesson.
- **access patterns**: access patterns is a key concept in this lesson.
- **Trade-offs vs relational design**: Trade-offs vs relational design is a key concept in this lesson.
