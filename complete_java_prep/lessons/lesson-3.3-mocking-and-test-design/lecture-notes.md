# Detailed Lecture Notes - Lesson 3.3: Mocking and Test Design

## Lesson Context
- Module: Software Engineering Essentials (Weeks 8-10)
- Primary topics: Mockito basics, fakes vs mocks; Testing service boundaries
- Target output: Test suite for service layer
...
- **Mockito basics**: Mockito basics is a key concept in this lesson.
- **fakes vs mocks**: fakes vs mocks is a key concept in this lesson.
- **Testing service boundaries**: Testing service boundaries is a key concept in this lesson.
