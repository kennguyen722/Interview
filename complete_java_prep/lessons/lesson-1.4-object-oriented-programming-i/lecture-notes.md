# Detailed Lecture Notes - Lesson 1.4: Object-Oriented Programming I

## Lesson Context
- Module: Java Core for Beginners (Weeks 2-4)
- Primary topics: Classes, objects, constructors, encapsulation; Access modifiers and package basics
- Target output: Domain model for a library system
...
- **Classes**: Classes is a key concept in this lesson.
- **objects**: objects is a key concept in this lesson.
- **constructors**: constructors is a key concept in this lesson.
- **encapsulation**: Bundling state and behavior together while controlling access.
- **Access modifiers**: Access modifiers is a key concept in this lesson.
- **package basics**: package basics is a key concept in this lesson.
