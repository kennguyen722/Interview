# Detailed Lecture Notes - Lesson 10.1: Architecture Decision Records (ADRs)

## Lesson Context
- Module: Professional Engineering and Leadership (Weeks 29-30)
- Primary topics: Writing clear decisions and rationale; Managing decision lifecycle
- Target output: ADR set for capstone
...
- **Writing clear decisions**: Writing clear decisions is a key concept in this lesson.
- **rationale**: rationale is a key concept in this lesson.
- **Managing decision lifecycle**: Managing decision lifecycle is a key concept in this lesson.
