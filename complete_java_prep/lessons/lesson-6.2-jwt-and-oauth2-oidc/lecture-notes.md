# Detailed Lecture Notes - Lesson 6.2: JWT and OAuth2/OIDC

## Lesson Context
- Module: Security and Identity (Weeks 17-18)
- Primary topics: Token lifecycle, claims, refresh flow; Integrating external identity providers
- Target output: OAuth2 login + JWT secured APIs
...
- **Token lifecycle**: Token lifecycle is a key concept in this lesson.
- **claims**: claims is a key concept in this lesson.
- **refresh flow**: refresh flow is a key concept in this lesson.
- **Integrating external identity providers**: Integrating external identity providers is a key concept in this lesson.
