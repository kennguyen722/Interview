# Detailed Lecture Notes - Lesson 8.5: Performance and Capacity Planning

## Lesson Context
- Module: DevOps and Platform Engineering (Weeks 21-24)
- Primary topics: JVM tuning basics, GC understanding; Load testing (k6/JMeter) and bottleneck analysis
- Target output: Performance benchmark report
...
- **JVM tuning basics**: JVM tuning basics is a key concept in this lesson.
- **GC understanding**: GC understanding is a key concept in this lesson.
- **Load testing**: Load testing is a key concept in this lesson.
- **JMeter**: JMeter is a key concept in this lesson.
- **bottleneck analysis**: bottleneck analysis is a key concept in this lesson.
