# Exercise Answers - Lesson 8.5: Performance and Capacity Planning
...
- Process: logic for JVM tuning basics, GC understanding; Load testing (k6/JMeter) and bottleneck analysis.
