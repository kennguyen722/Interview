# Detailed Lecture Notes - Lesson 4.5: Advanced Querying and Performance

## Lesson Context
- Module: Spring Boot Backend Development (Weeks 11-14)
- Primary topics: JPQL, Criteria, projections; N+1 problem and fetch strategies
- Target output: Optimized endpoint with measurable improvements
...
- **JPQL**: JPQL is a key concept in this lesson.
- **Criteria**: Criteria is a key concept in this lesson.
- **projections**: projections is a key concept in this lesson.
- **N+1 problem**: N+1 problem is a key concept in this lesson.
- **fetch strategies**: fetch strategies is a key concept in this lesson.
