# Sample Project: Lesson 4.5

## Goal
Build a working mini project for **Advanced Querying and Performance**.
...
- Output aligns with: **Optimized endpoint with measurable improvements**.
