# Detailed Lecture Notes - Lesson 11.1: Capstone Planning

## Lesson Context
- Module: Capstone and Interview Readiness (Weeks 31-32)
- Primary topics: Select domain and scope MVP; Define milestones and risk register
- Target output: Capstone execution plan
...
- **Select domain**: Select domain is a key concept in this lesson.
- **scope MVP**: scope MVP is a key concept in this lesson.
- **Define milestones**: Define milestones is a key concept in this lesson.
- **risk register**: risk register is a key concept in this lesson.
