# Detailed Lecture Notes - Lesson 9.2: Spring Cloud Patterns

## Lesson Context
- Module: Advanced Architecture and Distributed Systems (Weeks 25-28)
- Primary topics: Config server, service discovery, gateway; Circuit breaker, retries, bulkheads
- Target output: Resilient multi-service demo
...
- **Config server**: Config server is a key concept in this lesson.
- **service discovery**: service discovery is a key concept in this lesson.
- **gateway**: gateway is a key concept in this lesson.
- **Circuit breaker**: Circuit breaker is a key concept in this lesson.
- **retries**: retries is a key concept in this lesson.
- **bulkheads**: bulkheads is a key concept in this lesson.
