# Detailed Lecture Notes - Lesson 1.6: Exception Handling and Validation

## Lesson Context
- Module: Java Core for Beginners (Weeks 2-4)
- Primary topics: Checked vs unchecked exceptions; try/catch/finally, custom exceptions; Input/domain validation strategy
- Target output: Robust error handling in mini app
...
- **Checked vs unchecked exceptions**: Checked vs unchecked exceptions is a key concept in this lesson.
- **try**: try is a key concept in this lesson.
- **catch**: catch is a key concept in this lesson.
- **finally**: finally is a key concept in this lesson.
- **custom exceptions**: custom exceptions is a key concept in this lesson.
- **Input**: Input is a key concept in this lesson.
- **domain validation strategy**: domain validation strategy is a key concept in this lesson.
