# Exercise Answers - Lesson 1.6: Exception Handling and Validation
...
- Process: logic for Checked vs unchecked exceptions; try/catch/finally, custom exceptions; Input/domain validation strategy.
