# Detailed Lecture Notes - Lesson 6.1: Spring Security Fundamentals

## Lesson Context
- Module: Security and Identity (Weeks 17-18)
- Primary topics: Security filter chain and authentication basics; Role-based authorization
- Target output: Protected API endpoints
...
- **Security filter chain**: Security filter chain is a key concept in this lesson.
- **authentication basics**: authentication basics is a key concept in this lesson.
- **Role-based authorization**: Role-based authorization is a key concept in this lesson.
