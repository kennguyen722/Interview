# Detailed Lecture Notes - Lesson 3.1: Clean Code and Refactoring

## Lesson Context
- Module: Software Engineering Essentials (Weeks 8-10)
- Primary topics: Naming, cohesion, coupling; Code smells and refactoring patterns
- Target output: Refactor a legacy-style class set
...
- **Naming**: Naming is a key concept in this lesson.
- **cohesion**: cohesion is a key concept in this lesson.
- **coupling**: coupling is a key concept in this lesson.
- **Code smells**: Code smells is a key concept in this lesson.
- **refactoring patterns**: refactoring patterns is a key concept in this lesson.
