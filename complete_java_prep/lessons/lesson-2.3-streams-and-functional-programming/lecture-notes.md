# Detailed Lecture Notes - Lesson 2.3: Streams and Functional Programming

## Lesson Context
- Module: Java Intermediate Core (Weeks 5-7)
- Primary topics: Lambda expressions and method references; Stream operations and collectors
- Target output: Reporting pipeline on sample dataset
...
- **Lambda expressions**: Lambda expressions is a key concept in this lesson.
- **method references**: method references is a key concept in this lesson.
- **Stream operations**: Stream operations is a key concept in this lesson.
- **collectors**: collectors is a key concept in this lesson.
