# Detailed Lecture Notes - Lesson 7.1: TypeScript Fundamentals for Frontend

## Lesson Context
- Module: Frontend for Java Full Stack (Weeks 19-20)
- Primary topics: Types, interfaces, utility types; Project structure for maintainable frontends
- Target output: Type-safe utilities and domain models
...
- **Types**: Types is a key concept in this lesson.
- **interfaces**: interfaces is a key concept in this lesson.
- **utility types**: utility types is a key concept in this lesson.
- **Project structure for maintainable frontends**: Project structure for maintainable frontends is a key concept in this lesson.
