# Sample Project: Lesson 7.1

## Goal
Build a working mini project for **TypeScript Fundamentals for Frontend**.
...
- Output aligns with: **Type-safe utilities and domain models**.
