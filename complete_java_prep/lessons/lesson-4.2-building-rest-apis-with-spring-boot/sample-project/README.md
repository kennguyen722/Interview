# Sample Project: Lesson 4.2

## Goal
Build a working mini project for **Building REST APIs with Spring Boot**.
...
- Output aligns with: **CRUD API with professional error responses**.
