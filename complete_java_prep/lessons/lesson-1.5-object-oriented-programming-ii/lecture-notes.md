# Detailed Lecture Notes - Lesson 1.5: Object-Oriented Programming II

## Lesson Context
- Module: Java Core for Beginners (Weeks 2-4)
- Primary topics: Inheritance, polymorphism, abstraction, interfaces; Composition vs inheritance
- Target output: Refactor library model with interfaces
...
- **Composition vs inheritance**: Composition vs inheritance is a key concept in this lesson.
