# Exercise Answers - Lesson 0.1: Developer Environment Setup
...
- Process: logic for Install JDK (LTS), IntelliJ IDEA/VS Code, Maven and Gradle; Configure Git, GitHub, terminal workflows; Project structure conventions for Java and full-stack repos.
