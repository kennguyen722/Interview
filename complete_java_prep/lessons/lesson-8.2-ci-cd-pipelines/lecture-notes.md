# Detailed Lecture Notes - Lesson 8.2: CI/CD Pipelines

## Lesson Context
- Module: DevOps and Platform Engineering (Weeks 21-24)
- Primary topics: Build, test, lint, security scan, artifact publishing; GitHub Actions/Jenkins pipeline structure
- Target output: Automated pipeline with quality gates
...
- **Build**: Build is a key concept in this lesson.
- **test**: test is a key concept in this lesson.
- **lint**: lint is a key concept in this lesson.
- **security scan**: security scan is a key concept in this lesson.
- **artifact publishing**: artifact publishing is a key concept in this lesson.
- **GitHub Actions**: GitHub Actions is a key concept in this lesson.
- **Jenkins pipeline structure**: Jenkins pipeline structure is a key concept in this lesson.
