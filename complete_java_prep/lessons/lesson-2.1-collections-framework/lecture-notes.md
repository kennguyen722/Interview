# Detailed Lecture Notes - Lesson 2.1: Collections Framework

## Lesson Context
- Module: Java Intermediate Core (Weeks 5-7)
- Primary topics: List, Set, Map, Queue; Big-O intuition for collection choices
- Target output: In-memory inventory system
...
- **List**: List is a key concept in this lesson.
- **Set**: Set is a key concept in this lesson.
- **Map**: Map is a key concept in this lesson.
- **Queue**: Queue is a key concept in this lesson.
- **Big-O intuition for collection choices**: Big-O intuition for collection choices is a key concept in this lesson.
