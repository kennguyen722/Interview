# Exercise Answers - Lesson 0.3: SDLC and Professional Workflow
...
- Process: logic for Branching strategy, pull requests, code review basics; Issue tracking and task breakdown; Definition of done and acceptance criteria.
