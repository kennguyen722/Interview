# Detailed Lecture Notes - Lesson 0.3: SDLC and Professional Workflow

## Lesson Context
- Module: Foundations and Setup (Week 1)
- Primary topics: Branching strategy, pull requests, code review basics; Issue tracking and task breakdown; Definition of done and acceptance criteria
- Target output: First professional workflow simulation
...
- **Branching strategy**: Branching strategy is a key concept in this lesson.
- **pull requests**: pull requests is a key concept in this lesson.
- **code review basics**: code review basics is a key concept in this lesson.
- **Issue tracking**: Issue tracking is a key concept in this lesson.
- **task breakdown**: task breakdown is a key concept in this lesson.
- **Definition of done**: Definition of done is a key concept in this lesson.
- **acceptance criteria**: acceptance criteria is a key concept in this lesson.
