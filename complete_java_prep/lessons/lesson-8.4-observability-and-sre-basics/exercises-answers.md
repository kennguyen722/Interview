# Exercise Answers - Lesson 8.4: Observability and SRE Basics
...
- Process: logic for Metrics, logs, traces (Prometheus/Grafana/OpenTelemetry); SLI/SLO, error budgets, alerting fundamentals.
