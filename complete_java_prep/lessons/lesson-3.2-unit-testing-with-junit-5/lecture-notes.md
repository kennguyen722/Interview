# Detailed Lecture Notes - Lesson 3.2: Unit Testing with JUnit 5

## Lesson Context
- Module: Software Engineering Essentials (Weeks 8-10)
- Primary topics: Test anatomy, assertions, fixtures; Parameterized tests and edge cases
- Target output: 80%+ coverage on module project
...
- **Test anatomy**: Test anatomy is a key concept in this lesson.
- **assertions**: assertions is a key concept in this lesson.
- **fixtures**: fixtures is a key concept in this lesson.
- **Parameterized tests**: Parameterized tests is a key concept in this lesson.
- **edge cases**: edge cases is a key concept in this lesson.
