# Detailed Lecture Notes - Lesson 4.3: Persistence with Spring Data JPA

## Lesson Context
- Module: Spring Boot Backend Development (Weeks 11-14)
- Primary topics: Entity modeling, relationships, repositories; Transaction boundaries and service layer patterns
- Target output: API persisted in PostgreSQL
...
- **Entity modeling**: Entity modeling is a key concept in this lesson.
- **relationships**: relationships is a key concept in this lesson.
- **repositories**: repositories is a key concept in this lesson.
- **Transaction boundaries**: Transaction boundaries is a key concept in this lesson.
- **service layer patterns**: service layer patterns is a key concept in this lesson.
