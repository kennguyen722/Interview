# Detailed Lecture Notes - Lesson 4.4: Database Migration and Seed Data

## Lesson Context
- Module: Spring Boot Backend Development (Weeks 11-14)
- Primary topics: Flyway/Liquibase migrations; Repeatable schema evolution strategy
- Target output: Versioned database migration setup
...
- **Flyway**: Flyway is a key concept in this lesson.
- **Liquibase migrations**: Liquibase migrations is a key concept in this lesson.
- **Repeatable schema evolution strategy**: Repeatable schema evolution strategy is a key concept in this lesson.
