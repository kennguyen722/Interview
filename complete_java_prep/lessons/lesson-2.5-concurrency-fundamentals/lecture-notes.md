# Detailed Lecture Notes - Lesson 2.5: Concurrency Fundamentals

## Lesson Context
- Module: Java Intermediate Core (Weeks 5-7)
- Primary topics: Threads, executors, futures; Synchronization and concurrent collections
- Target output: Parallel task processor with metrics
...
- **Threads**: Threads is a key concept in this lesson.
- **executors**: executors is a key concept in this lesson.
- **futures**: futures is a key concept in this lesson.
- **Synchronization**: Synchronization is a key concept in this lesson.
- **concurrent collections**: concurrent collections is a key concept in this lesson.
