# Detailed Lecture Notes - Lesson 9.4: API Gateway and BFF

## Lesson Context
- Module: Advanced Architecture and Distributed Systems (Weeks 25-28)
- Primary topics: Edge concerns, rate limiting, auth at gateway; Backend-for-Frontend strategy
- Target output: Gateway/BFF implementation plan
...
- **Edge concerns**: Edge concerns is a key concept in this lesson.
- **rate limiting**: rate limiting is a key concept in this lesson.
- **auth at gateway**: auth at gateway is a key concept in this lesson.
- **Backend-for-Frontend strategy**: Backend-for-Frontend strategy is a key concept in this lesson.
