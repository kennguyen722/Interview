# Detailed Lecture Notes - Lesson 7.2: React Fundamentals

## Lesson Context
- Module: Frontend for Java Full Stack (Weeks 19-20)
- Primary topics: Components, props/state, hooks; Routing and state management options
- Target output: Multi-page app shell
...
- **Components**: Components is a key concept in this lesson.
- **props**: props is a key concept in this lesson.
- **state**: state is a key concept in this lesson.
- **hooks**: hooks is a key concept in this lesson.
- **Routing**: Routing is a key concept in this lesson.
- **state management options**: state management options is a key concept in this lesson.
