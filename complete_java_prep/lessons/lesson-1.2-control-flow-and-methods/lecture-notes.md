# Detailed Lecture Notes - Lesson 1.2: Control Flow and Methods

## Lesson Context
- Module: Java Core for Beginners (Weeks 2-4)
- Primary topics: if/else, switch, loops; Method design, parameters, return values
- Target output: Menu-driven console mini app
...
- **else**: else is a key concept in this lesson.
- **switch**: switch is a key concept in this lesson.
- **loops**: loops is a key concept in this lesson.
- **Method design**: Method design is a key concept in this lesson.
- **parameters**: parameters is a key concept in this lesson.
- **return values**: return values is a key concept in this lesson.
