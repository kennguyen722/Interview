# Detailed Lecture Notes - Lesson 0.2: Build Tools and Project Lifecycle

## Lesson Context
- Module: Foundations and Setup (Week 1)
- Primary topics: Maven lifecycle, POM basics, dependency scopes; Gradle basics and build scripts; Running tests and packaging jars
- Target output: Build and run a starter CLI app with both tools
...
- **Maven lifecycle**: Maven lifecycle is a key concept in this lesson.
- **POM basics**: POM basics is a key concept in this lesson.
- **dependency scopes**: dependency scopes is a key concept in this lesson.
- **Gradle basics**: Gradle basics is a key concept in this lesson.
- **build scripts**: build scripts is a key concept in this lesson.
- **Running tests**: Running tests is a key concept in this lesson.
- **packaging jars**: packaging jars is a key concept in this lesson.
