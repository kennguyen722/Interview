# Exercise Answers - Lesson 0.2: Build Tools and Project Lifecycle
...
- Process: logic for Maven lifecycle, POM basics, dependency scopes; Gradle basics and build scripts; Running tests and packaging jars.
